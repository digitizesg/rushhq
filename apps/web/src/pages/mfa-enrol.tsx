    ...
    <main className="min-h-dvh grid place-items-center px-6 py-12">
      <div className="w-full max-w-md bg-white border border-line rounded-lg p-7">
        ...
        {pending ? (
          ...
          <p className="text-muted text-[14px]">{error ?? "Loading enrolment…"}</p>
        )}
        <button
          type="button"
          onClick={() => {
          ...
          className="block mx-auto mt-6 text-[13px] text-muted hover:text-ink underline-offset-2 hover:underline"
        >
          Sign out
        </button>
      </div>
