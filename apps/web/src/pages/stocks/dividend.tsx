  ...
  return (
    <section className="mx-auto max-w-[640px] px-4 sm:px-6 py-6 sm:py-10 space-y-6">
      ...
      <div>
        ...
        <h1 className="text-[26px] font-medium text-ink">Record dividend reinvest</h1>
      ...
      <section className="bg-white border border-line rounded-lg overflow-hidden">
        <header className="px-5 py-3 bg-soft border-b border-line">
          <p className="text-[14px] font-semibold text-ink">Current holdings</p>
        </header>
        <ul className="divide-y divide-line">
          {data.holdings.map((h) => (
            <li key={h.member_id} className="px-5 py-3 flex items-center justify-between text-[14px]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <section className="bg-white border border-line rounded-lg p-5 space-y-4">
          <p className="text-[14px] font-semibold text-ink">Reinvest details</p>
        ...
        {sharesNum > 0 && totalShares > 0 && (
          <section className="bg-soft border border-line rounded-lg p-5 space-y-2">
            <p className="text-[14px] font-semibold text-ink">Pro-rata allocation</p>
            ...
            <p className="text-[12.5px] text-muted pt-2 border-t border-line">
