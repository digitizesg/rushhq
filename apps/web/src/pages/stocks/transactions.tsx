    ...
    >
      <div className="w-full max-w-lg bg-white rounded-lg border border-line p-5 space-y-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="border border-line rounded-md overflow-hidden">
          <p className="text-[12px] uppercase tracking-wider text-muted bg-soft px-3 py-2 border-b border-line">
            Allocations
          </p>
          <ul className="divide-y divide-line">
            {allocations.map((a) => {
              ...
              return (
                <li key={a.id} className="flex items-baseline justify-between px-3 py-2 text-[13px]">
        ...
        {error && (
          <div className="rounded-md border border-danger/40 bg-danger/[0.06] text-danger text-[13px] px-3 py-2">
            {error}
          </div>
        )}
        ...
        {confirmDelete && (
          <div className="absolute inset-0 z-10 grid place-items-center bg-white/85 rounded-lg p-5">
            <div className="w-full max-w-sm bg-white rounded-lg border border-line p-5 shadow-lg">
              <p className="text-[18px] font-semibold text-ink mb-2">Delete this transaction?</p>
