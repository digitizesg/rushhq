...
export function TelegramCard({ memberId, heading }: TelegramCardProps) {
  ...
  return (
    <div className="bg-white border border-line rounded-lg p-6">
      ...
      {state.kind === "loading" && (
        <p className="text-muted text-[15.5px]">Loading…</p>
      )}
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="inline-flex h-10 items-center px-4 rounded-md bg-primary text-white text-[16px] font-medium hover:bg-[#4f7741]"
            >
              Open in Telegram
            </a>
          ...
          <code className="block text-[14px] bg-soft border border-line rounded-md p-2 text-ink break-all">
      ...
      {state.kind === "expired" && (
        <div className="space-y-3">
          <p className="text-danger text-[15.5px]">
      ...
      {error && (
        <p className="mt-3 text-danger text-[15px]" role="alert">
          {error}
        </p>
      )}
    </div>
